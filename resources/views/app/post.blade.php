...
@section('content')
  <main class="mx-auto container p-4">
    ...
    <div class="post-content mx-auto bg-white rounded-lg overflow-hidden shadow-lg">
      <div class="bg-cover h-40" style="background-image: url('{{ asset('img/portlet/'.$post->author->information->portlet) }}');">
      </div>
      <div class="border-b px-4 pb-2">
        <div class="text-center sm:text-left sm:flex mb-2">
          <img class="mx-auto md:mx-0 h-32 w-32 rounded-full border-4 border-white -mt-16 lg:mr-4 lg:mx-0" src="{{ $post->author->photo }}" alt="{{ $post->author->email }}" loading="lazy">
          <div class="py-2 flex-col">
            <a href="{{ route('me', $post->author->username) }}" class="flex font-bold text-2xl mb-1" title="Ver más información de {{ $post->author->fullname }}">{{ $post->author->fullname }}<i>({{ '@'.$post->author->username }})</i></a>
        ...
        <div class="flex justify-end text-gray-700 pb-2">
          ...
          <a target="_blank" class="hover:text-blue-700 ml-2" href="{{ $post->author->information->facebook }}" title="Facebook">
          ...
          <a target="_blank" class="hover:text-blue-500 ml-2" href="{{ $post->author->information->twitter }}" title="Twitter">
          ...
          <a target="_blank" class="hover:text-red-700 ml-2" href="{{ $post->author->information->youtube }}" title="Youtube">
          ...
          <a target="_blank" class="hover:text-blue-600 ml-2" href="{{ $post->author->information->linkedin }}" title="Linkedin">
          ...
          <a target="_blank" class="hover:text-gray-900 ml-2" href="{{ $post->author->information->medium }}" title="Medium">
          ...
          <a target="_blank" class="hover:text-red-900 ml-2" href="{{ $post->author->information->pinterest }}" title="Pinterest">
          ...
          <a target="_blank" class="hover:text-gray-900 ml-2" href="{{ $post->author->information->github }}" title="GitHub">
          ...
          <a target="_blank" class="hover:text-orange-700 ml-2" href="{{ $post->author->information->gitlab }}" title="GitLab">
          ...
          <a target="_blank" class="hover:text-gray-900 ml-2" href="{{ $post->author->information->codepen }}" title="Codepen">
          ...
          <a target="_blank" class="hover:text-blue-900 ml-2" href="{{ $post->author->information->jsfiddle }}" title="JSFiddle">
          ...
          <a target="_blank" class="hover:text-gray-900 ml-2" href="{{ $post->author->information->reddit }}" title="Reddit">
          ...
          <a target="_blank" class="hover:text-blue-700 ml-2" href="{{ $post->author->information->telegram }}" title="Telegram">
          ...
          <a target="_blank" class="hover:text-green-800 ml-2" href="{{ $post->author->information->whatsapp }}" title="Whatsapp">
