      ...
      <div class="border-b px-4 pb-2">
        <div class="text-center sm:text-left sm:flex mb-2">
          ...
          <div class="py-2 flex-col">
            <a href="{{ url('/') }}" class="flex font-bold text-2xl mb-1" title="Ver más información de {{ $post->author->fullname }}">{{ $post->author->fullname }}</a>
        ...
        <div class="flex justify-end text-gray-700 pb-2">
          <a class="hover:text-blue-700 ml-2" href="" title="Facebook">
          ...
          <a class="hover:text-blue-500 ml-2" href="" title="Twitter">
          ...
          <a class="hover:text-red-700 ml-2" href="" title="Youtube">
          ...
          <a class="hover:text-blue-600 ml-2" href="" title="Linkedin">
          ...
          <a class="hover:text-gray-900 ml-2" href="" title="Medium">
          ...
          <a class="hover:text-red-900 ml-2" href="" title="Pinterest">
          ...
          <a class="hover:text-gray-900 ml-2" href="" title="GitHub">
          ...
          <a class="hover:text-gray-900 ml-2" href="" title="Codepen">
          ...
          <a class="hover:text-blue-900 ml-2" href="" title="JSFiddle">
          ...
          <a class="hover:text-orange-700 ml-2" href="" title="GitLab">
          ...
          <a class="hover:text-gray-900 ml-2" href="" title="Reddit">
          ...
          <a class="hover:text-blue-700 ml-2" href="" title="Telegram">
          ...
          <a class="hover:text-green-800 ml-2" href="" title="Whatsapp">
