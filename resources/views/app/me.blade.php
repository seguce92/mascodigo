...
@section('content')
  <main class="mx-auto pt-8 p-4">
    <div class="post-content mx-auto bg-white rounded-lg overflow-hidden shadow-lg">
        ...
        <div class="border-b px-4 pb-2">
            <div class="text-center sm:text-left sm:flex mb-2">
                <img class="mx-auto md:mx-0 h-32 w-32 rounded-full border-4 border-white -mt-16 lg:mr-4 lg:mx-0" src="{{ $user->photo }}" alt="{{ $user->username }}">
                <div class="py-2 flex-col">
                    <a href="{{ route('me', $user->username) }}" class="flex font-bold text-2xl mb-1" title="Ver más información de {{ $user->fullname }}">{{ $user->fullname }} <i>({{ $user->username }})</i></a>
            ...
            <div class="flex justify-end text-gray-700 pb-2">
                @if ( $user->information && $user->information->facebook ) 
                    <a class="hover:text-blue-700 ml-2" href="{{ $user->information }}" title="Facebook">
                ...
                @if ( $user->information && $user->information->twitter )
                    <a class="hover:text-blue-500 ml-2" href="{{ $user->information->twitter }}" title="Twitter">
                ...
                @if ( $user->information && $user->information->youtube )
                    <a class="hover:text-red-700 ml-2" href="{{ $user->information->youtube }}" title="Youtube">
                ...
                @if ( $user->information && $user->information->linkedin )
                    <a class="hover:text-blue-600 ml-2" href="{{ $user->information->linkedin }}" title="Linkedin">
                ...
                @if ( $user->information && $user->information->medium )
                    <a class="hover:text-gray-900 ml-2" href="{{ $user->information->medium }}" title="Medium">
                ...
                @if ( $user->information && $user->information->pinterest )
                    <a class="hover:text-red-900 ml-2" href="{{ $user->information->pinterest }}" title="Pinterest">
                ...
                @if ( $user->information && $user->information->github )
                    <a class="hover:text-gray-900 ml-2" href="{{ $user->information->github }}" title="GitHub">
                ...
                @if ( $user->information && $user->information->gitlab )
                    <a class="hover:text-orange-700 ml-2" href="{{ $user->information->gitlab }}" title="GitLab">
                ...
                @if ( $user->information && $user->information->codepen )
                    <a class="hover:text-gray-900 ml-2" href="{{ $user->information->codepen }}" title="Codepen">
                ...
                @if ( $user->information && $user->information->jsfiddle )
                    <a class="hover:text-blue-900 ml-2" href="{{ $user->information->jsfiddle }}" title="JSFiddle">
                ...
                @if ( $user->information && $user->information->reddit )
                    <a class="hover:text-gray-900 ml-2" href="{{ $user->information->reddit }}" title="Reddit">
                ...
                @if ( $user->information && $user->information->telegram )
                    <a class="hover:text-blue-700 ml-2" href="{{ $user->information->telegram }}" title="Telegram">
                ...
                @if ( $user->information && $user->information->whatsapp )
                    <a class="hover:text-green-800 ml-2" href="{{ $user->information->whatsapp }}" title="Whatsapp">
    ...
    @if ( $user->information && $user->information->content )
        <div class="post-content mx-auto mt-8 p-4">
