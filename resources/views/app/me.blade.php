...
@section('seo')
  ...
  <meta property="og:url" content="{{ route('me', $user->username) }}" />
  ...
  <meta itemprop="name" content="{{ $user->fullname.'(@'.$user->username.')' }}">
...
@section('content')
  <main class="mx-auto pt-8 p-4">
    <div class="post-content mx-auto bg-white rounded-lg overflow-hidden shadow-lg">
      <div class="bg-cover h-40 relative" style="background-image: url('{{ asset('img/portlet/'.$user->information->portlet) }}');">
        <span class="absolute right-0 mr-2 px-2 bg-white mt-2 rounded-lg shadow-lg"><strong>XP {{ $user->xp }}</strong></span>
      </div>
      <div class="border-b px-4 pb-2">
        ...
        <div class="flex justify-end text-gray-700 pb-2">
          @if ( $user->information && $user->information->facebook ) 
            <a target="_blank" class="hover:text-blue-700 ml-2" href="{{ $user->information->facebook }}" title="Facebook">
          ...
          @endif
          @if ( $user->information && $user->information->twitter )
            <a target="_blank" class="hover:text-blue-500 ml-2" href="{{ $user->information->twitter }}" title="Twitter">
          ...
          @endif
          @if ( $user->information && $user->information->youtube )
            <a target="_blank" class="hover:text-red-700 ml-2" href="{{ $user->information->youtube }}" title="Youtube">
          ...
          @if ( $user->information && $user->information->linkedin )
            <a target="_blank" class="hover:text-blue-600 ml-2" href="{{ $user->information->linkedin }}" title="Linkedin">
          ...
          @endif
          @if ( $user->information && $user->information->medium )
            <a target="_blank" class="hover:text-gray-900 ml-2" href="{{ $user->information->medium }}" title="Medium">
          ...
          @endif
          @if ( $user->information && $user->information->pinterest )
            <a target="_blank" class="hover:text-red-900 ml-2" href="{{ $user->information->pinterest }}" title="Pinterest">
          ...
          @if ( $user->information && $user->information->github )
            <a target="_blank" class="hover:text-gray-900 ml-2" href="{{ $user->information->github }}" title="GitHub">
          ...
          @endif
          @if ( $user->information && $user->information->gitlab )
            <a target="_blank" class="hover:text-orange-700 ml-2" href="{{ $user->information->gitlab }}" title="GitLab">
          ...
          @endif
          @if ( $user->information && $user->information->codepen )
            <a target="_blank" class="hover:text-gray-900 ml-2" href="{{ $user->information->codepen }}" title="Codepen">
          ...
          @endif
          @if ( $user->information && $user->information->jsfiddle )
            <a target="_blank" class="hover:text-blue-900 ml-2" href="{{ $user->information->jsfiddle }}" title="JSFiddle">
          ...
          @endif
          @if ( $user->information && $user->information->reddit )
            <a target="_blank" class="hover:text-gray-900 ml-2" href="{{ $user->information->reddit }}" title="Reddit">
          ...
          @endif
          @if ( $user->information && $user->information->telegram )
            <a target="_blank" class="hover:text-blue-700 ml-2" href="{{ $user->information->telegram }}" title="Telegram">
          ...
          @endif
          @if ( $user->information && $user->information->whatsapp )
            <a target="_blank" class="hover:text-green-800 ml-2" href="{{ $user->information->whatsapp }}" title="Whatsapp">
    ...
    @if ( $user->information && $user->information->content )
      <article class="post-content mx-auto mt-8 p-4 text-xl leading-loose">
        {!! \Illuminate\Mail\Markdown::parse($user->information->content) !!}
      </article>
    @endif

    <div class="flex justify-center flex-wrap mt-4">
      <div class="flex justify-center flex-wrap container">
        <h4 class="font-bold text-2xl border rounded-full px-4 shadow border-gray-400">Posts de {{ $user->username }}</h4>
      </div>
    </div>
