      ...
      <div class="flex flex-col w-full pt-12 pl-4 pr-4 lg:pt-0 lg:w-2/3 order-2 lg:order-1 text-center lg:text-left">
        ...
        <div class="w-full">
          ...
          <a href="{{ route('lesson', ['course' => $course->slug, 'order' => 1]) }}" 
            class="shadow hover:bg-white inline-flex items-center text-white-700 font-semibold hover:text-black py-2 px-6 border border-white rounded-full">
      ...
      <nav class="flex justify-between items-stretch w-full text-black container mx-auto">
        ...
        <div class="flex items-stretch flex-no-shrink h-12">
          <div class="flex items-stretch justify-end ml-auto">
            ...
            <a target="_blank" href="{{ social_share('facebook', $course->slug, $course->title) }}" title="FACEBOOK" class="text-gray-600 hover:text-blue-700 flex-no-grow flex-no-shrink relative py-2 pl-3 pr-2 leading-normal no-underline flex items-center ">
            ...
            <a target="_blank" href="{{ social_share('twitter', $course->slug, $course->title) }}" title="TWITTER" class="text-gray-600 hover:text-blue-500 flex-no-grow flex-no-shrink relative py-2 px-2 leading-normal no-underline flex items-center">
            ...
            <a target="_blank" href="{{ social_share('telegram', $course->slug, $course->title) }}" title="TELEGRAM" class="text-gray-600 hover:text-blue-800 flex-no-grow flex-no-shrink relative py-2 px-2 leading-normal no-underline flex items-center">
