        ...
        <div class="bg-white border rounded shadow p-2">
            <div class="flex flex-row items-center">
                ...
                <div class="flex-1 text-right md:text-center">
                    ...
                    <h3 class="font-normal text-3xl text-gray-700">{{ $courses->where('is_publish', 1)->count() }}</h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white border rounded shadow p-2">
            <div class="flex flex-row items-center">
                ...
                <div class="flex-1 text-right md:text-center">
                    ...
                    <h3 class="font-normal text-3xl text-gray-700">{{ total_lessons() }}</h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white border rounded shadow p-2">
            <div class="flex flex-row items-center">
                ...
                <div class="flex-1 text-right md:text-center">
                    ...
                    <h3 class="font-normal text-3xl text-gray-700">{{ total_time() }}</h3>
                </div>
            </div>
        </div>
    </div>
