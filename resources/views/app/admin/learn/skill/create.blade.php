  ...
  <div class="bg-white border rounded shadow p-2">
    <form class="w-full" action="{{ route('skills.store') }}" method="POST">
      ...
      <div class="flex flex-wrap">
        <div class="w-full">
          <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="title">Habilidad</label>
          <input class="appearance-none block w-full text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none" id="name" name="name" type="text" placeholder="Habilidad" onkeyup="generateSlug()" value="{{ old('name') }}">
        </div>
