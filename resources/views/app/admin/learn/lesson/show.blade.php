  ...
  <div class="flex flex-wrap lg:flex-no-wrap w-full">
    ...
    <div class="flex flex-wrap w-full lg:w-8/12 bg-white border rounded shadow p-2 mr-0 lg:mr-2">
      ...
      <div class="w-1/3">
        ...
        <label class="inline-flex items-center mr-5">
          <input type="radio" class="form-radio h-6 w-6" name="is_premium" value="1" {{ $lesson->is_premium ? 'checked' : '' }}>
          <span class="ml-2">Premium</span>
        </label>
        <label class="inline-flex items-center">
          <input type="radio" class="form-radio h-6 w-6" name="is_premium" value="0" {{ $lesson->is_premium ? '' : 'checked' }}>
