...
<div class="bg-red-500 text-center py-2 lg:px-2">
    <div class="p-2 bg-red-700 items-center text-danger-100 leading-none lg:rounded-full flex lg:inline-flex" role="alert">
        <span class="flex rounded-full bg-danger-500 uppercase px-2 py-1 text-xs font-bold mr-3">
...
<div class="bg-green-500 text-center py-2 lg:px-2">
