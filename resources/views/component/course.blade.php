<div class="max-w-sm w-full w-1/1 lg:w-1/4 py-3 px-3">
    <div class="card php pt-4">
        <div class="overlay"></div>
        <a href="{{ route('course', 'el-curso') }}" class="circle text-white" title="INICIAR CURSO">
        ...
        <a class="skill shadow" href="#" title="INICIAR CURSO">Laravel</a>
        <a class="title font-serif" href="{{ route('course', 'el-curso') }}">Introduccion a laravel 5.8</a>
