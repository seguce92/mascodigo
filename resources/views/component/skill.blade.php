<div class="max-w-sm w-full w-1/1 lg:w-1/4 py-3 px-3">
    <div class="card php pt-4">
        ...
        <a href="{{ route('category', 'laravel') }}" class="circle text-white" title="EXPLORAR CURSOS">
        ...
        <a class="title font-serif uppercase" href="{{ route('category', 'laravel') }}" title="EXPLORAR CURSOS">Php</a>
        <div class="flex flex-wrap w-full py-4 description">
            <div class="flex w-1/2 inline-flex justify-center items-center text-sm text-gray-600 font-serif">
                <i class="text fas fa-book-open mr-2"></i>
                <p class="text">3 Cursos</p>
            </div>
            <div class="flex w-1/2 inline-flex justify-center items-center text-sm text-gray-600 font-serif">
